...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    private ItemDraggable mAdapter;
    ...
    public ItemDragSwipeCallback(ItemDraggable adapter) {
        mAdapter = adapter;
    }
...
//        }
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        return type == BackQuickAdapter.ITEM_TYPE_FOOTER || type == BackQuickAdapter.ITEM_TYPE_HEADER;
    }
}
